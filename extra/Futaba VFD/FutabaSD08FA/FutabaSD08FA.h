...
public:
  ...
  static const uint8_t END_OF_LINE_WRAP_CHARATCER = 0x11; // Wraps from end of second line to start for first line.
  static const uint8_t END_OF_LINE_NO_ADVANCE_CHARATCER = 0x12; // Cursor stops on the last position at end of display.
  static const uint8_t END_OF_LINE_HORIZONTAL_SCROLL_CHARATCER = 0x13; // Second line scrolls. No effect on first line.
