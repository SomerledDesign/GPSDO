...
#define VERSION "4.00"
#define ROLLOVER_YEAR 2015   // if GPS year is less than this,  assume it's a GPS week rollover fault
...
#define SQUARED     0xFD
   ...
   #else
      #define wd x
      #define HUGE_MEM huge   // define this for over 720 log entries (array exceeds 64K)
...
///#define VARIABLE_FONT
   ...
   EXTERN int root_len;
   #define BEEP() if(beep_on) XBell(display, 100);
   ...
   EXTERN Pixmap pix_map;
   #define win pix_map    // win is the drawing surface - either screen or pix_map
   EXTERN GC gc;
   ...
   #define RGB_NATIVE(r,g,b) ((wattr.depth == 16) ? ( (((u32) (r>>3))<<11) | (((u32) (g>>2))<<5) | ((u32) (b>>3)) ) : \
...
#define SUN_SECOND          26   // update sun position
#define TRAIL_UPDATE_SECOND 22   // update azel trails at 22 seconds
#define MOON_SECOND         18   // update moon position
...
#define FIVE_COLOR      RED 
#define SIX_COLOR       DIM_BLUE
#define SEVEN_COLOR     DIM_GREEN
#define EIGHT_COLOR     DIM_RED
#define NINE_COLOR      DIM_WHITE  
#define TEN_COLOR       DIM_MAGENTA
#define ELEVEN_COLOR    DIM_RED
#define TWELVE_COLOR    DIM_GREEN
#define THIRTEEN_COLOR  DIM_BLUE
#define FOURTEEN_COLOR  DIM_MAGENTA
...
EXTERN unsigned long max_ems_size;
...
#define SUN_PRN (32+1)
EXTERN struct SAT_INFO sat[SUN_PRN+1];
...
EXTERN double new_moon_jd;        // julian date of the previous new moon
...
#define USER_CHORD_FILE   "chord.wav"             // user defined sounds
#define USER_NOTIFY_FILE  "notify.wav"
#define LEAP_FILE         "heather_leapsec.wav"
#define MOON_FILE         "heather_moon.wav"
#define CHIME_FILE        "heather_chime.wav"
#define ALARM_FILE        "heather_alarm.wav"
#define SONG_NAME         "heather_song%02d.wav"
...
EXTERN u08 moon_file;     // flag set if user moon tune file exists
...
int time_check(int reading_log, u16 interval, int hh,int mm,int ss);
...
void config_res_t_plots(void);
void config_normal_plots(void);
void config_lla_plots(void);
