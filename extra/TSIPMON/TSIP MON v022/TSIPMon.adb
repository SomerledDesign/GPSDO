...
S:LPrimaryTiming$sec$1$1({1}SC:U),R,0,0,[r4]
S:LPrimaryTiming$min$1$1({1}SC:U),R,0,0,[r4]
S:LPrimaryTiming$hr$1$1({1}SC:U),R,0,0,[r4]
S:LPrimaryTiming$dom$1$1({1}SC:U),R,0,0,[r4]
S:LPrimaryTiming$mo$1$1({1}SC:U),R,0,0,[r4]
...
S:G$lcdbuf$0$0({17}DA17,SC:U),F,0,0
S:G$TxRxBuf$0$0({85}DA85,SC:U),F,0,0
S:G$LCDBuf$0$0({0}DA0,SC:S),F,0,0
...
S:G$VersionMsg$0$0({17}DA17,SC:U),D,0,0
S:G$LCDInitMsg$0$0({17}DA17,SC:U),D,0,0
S:G$prompt$0$0({18}DA2,DA9,SC:U),D,0,0
S:G$ALARM_MSG$0$0({0}DA16,DA0,SC:U),D,0,0
S:FTSIPMon$_str_0$0$0({16}DA16,SC:S),D,0,0
