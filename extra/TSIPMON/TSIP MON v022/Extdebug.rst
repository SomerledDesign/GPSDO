                              ...
                              4 ; This file generated Sun Dec 28 11:32:36 2008
                              5 ;--------------------------------------------------------
                              6 	.module Extdebug
   ...
   0041                     713 _Fault_Msg_Query_PARM_2::
   0041                     714 	.ds 2
                    0002    715 LFault_Msg_Query$msg$1$1==.
   0043                     716 _Fault_Msg_Query_PARM_3::
   0043                     717 	.ds 2
                            718 ;--------------------------------------------------------
   ...
   0DF7                     782 _Fault_Msg_Query:
                    ...
                    0001    790 	ar1 = 0x01
                            791 ;	genReceive
   0DF7 AA 82               792 	mov	r2,dpl
   0DF9 AB 83               793 	mov	r3,dph
                    0004    794 	C$Extdebug.c$106$1$1 ==.
                            795 ;	C:/SDCC/GPSMon/dev/Extdebug.c:106: if( Test_Result == 0 )
                            796 ;	genIfx
   0DFB EA                  797 	mov	a,r2
   0DFC 4B                  798 	orl	a,r3
                            799 ;	genIfxJump
   ...
   0E09 50 05               825 	jnc	00125$
                    ...
                    0014    827 	C$Extdebug.c$110$1$1 ==.
                            ...
                            829 ;	genAssign
   0E0B 90 00 BD            830 	mov	dptr,#_fault_query_ndx
                            831 ;	Peephole 181	changed mov to clr
   0E0E E4                  832 	clr	a
   0E0F F0                  833 	movx	@dptr,a
                    0019    834 	C$Extdebug.c$111$1$1 ==.
                            835 ;	C:/SDCC/GPSMon/dev/Extdebug.c:111: while( !(Test_Result & j<<fault_query_ndx) ){
   0E10                     836 00125$:
                            837 ;	genAssign
   0E10 7C 00               838 	mov	r4,#0x00
   0E12                     839 00108$:
                            840 ;	genAssign
   0E12 90 00 BD            841 	mov	dptr,#_fault_query_ndx
   0E15 E0                  842 	movx	a,@dptr
   0E16 FD                  843 	mov	r5,a
                            844 ;	genLeftShift
   0E17 8D F0               845 	mov	b,r5
   0E19 05 F0               846 	inc	b
   0E1B 7E 01               847 	mov	r6,#0x01
   0E1D 7F 00               848 	mov	r7,#0x00
   0E1F 80 06               849 	sjmp	00134$
   0E21                     850 00133$:
   0E21 EE                  851 	mov	a,r6
                            852 ;	Peephole 254	optimized left shift
   0E22 2E                  853 	add	a,r6
   0E23 FE                  854 	mov	r6,a
   0E24 EF                  855 	mov	a,r7
   0E25 33                  856 	rlc	a
   0E26 FF                  857 	mov	r7,a
   0E27                     858 00134$:
   0E27 D5 F0 F7            859 	djnz	b,00133$
                            860 ;	genAnd
   0E2A EA                  861 	mov	a,r2
   0E2B 52 06               862 	anl	ar6,a
   0E2D EB                  863 	mov	a,r3
   0E2E 52 07               864 	anl	ar7,a
                            865 ;	genIfx
   0E30 EE                  866 	mov	a,r6
   0E31 4F                  867 	orl	a,r7
                            868 ;	genIfxJump
                            869 ;	Peephole 108.b	removed ljmp by inverse jump logic
   0E32 70 22               870 	jnz	00110$
                    ...
                    003D    872 	C$Extdebug.c$112$2$2 ==.
                            ...
                            874 ;	genPlus
   0E34 90 00 BD            875 	mov	dptr,#_fault_query_ndx
                            876 ;     genPlusIncr
   0E37 74 01               877 	mov	a,#0x01
                            878 ;	Peephole 236.a	used r5 instead of ar5
   0E39 2D                  879 	add	a,r5
   0E3A F0                  880 	movx	@dptr,a
                    0044    881 	C$Extdebug.c$113$2$2 ==.
                            882 ;	C:/SDCC/GPSMon/dev/Extdebug.c:113: if( fault_query_ndx >= NUM_MSG || i++ >= NUM_MSG ){
                            883 ;	genAssign
   0E3B 90 00 BD            884 	mov	dptr,#_fault_query_ndx
   0E3E E0                  885 	movx	a,@dptr
   0E3F FE                  886 	mov	r6,a
                            887 ;	genCmpLt
                            888 ;	genCmp
   0E40 BE 10 00            889 	cjne	r6,#0x10,00136$
   0E43                     890 00136$:
                            891 ;	genIfxJump
                            892 ;	Peephole 108.a	removed ljmp by inverse jump logic
   0E43 50 08               893 	jnc	00105$
                            894 ;	Peephole 300	removed redundant label 00137$
                            895 ;	genAssign
   0E45 8C 06               896 	mov	ar6,r4
                            897 ;	genPlus
                            898 ;     genPlusIncr
   0E47 0C                  899 	inc	r4
                            900 ;	genCmpLt
                            901 ;	genCmp
   0E48 BE 10 00            902 	cjne	r6,#0x10,00138$
   0E4B                     903 00138$:
                            904 ;	genIfxJump
                            905 ;	Peephole 112.b	changed ljmp to sjmp
                            906 ;	Peephole 160.a	removed sjmp by inverse jump logic
   0E4B 40 C5               907 	jc	00108$
   ...
   0E56                     926 00110$:
                    005F    927 	C$Extdebug.c$120$1$1 ==.
                            ...
                            929 ;	genMult
                            930 ;	genMultOneByte
   0E56 ED                  931 	mov	a,r5
   0E57 75 F0 11            932 	mov	b,#0x11
   0E5A A4                  933 	mul	ab
                            934 ;	genPlus
   0E5B 25 43               935 	add	a,_Fault_Msg_Query_PARM_3
   0E5D FA                  936 	mov	r2,a
   0E5E E5 44               937 	mov	a,(_Fault_Msg_Query_PARM_3 + 1)
   0E60 35 F0               938 	addc	a,b
   0E62 FB                  939 	mov	r3,a
                            940 ;	genPointerGet
                            941 ;	genCodePointerGet
   0E63 8A 82               942 	mov	dpl,r2
   0E65 8B 83               943 	mov	dph,r3
   0E67 E4                  944 	clr	a
   0E68 93                  945 	movc	a,@a+dptr
                            946 ;	genIfxJump
                            947 ;	Peephole 108.b	removed ljmp by inverse jump logic
   0E69 70 13               948 	jnz	00129$
   ...
   0E7E                     980 00129$:
                            981 ;	genAssign
   0E7E 7A 00               982 	mov	r2,#0x00
   0E80                     983 00115$:
                            984 ;	genCmpLt
                            985 ;	genCmp
   0E80 BA 11 00            986 	cjne	r2,#0x11,00141$
   0E83                     987 00141$:
                            988 ;	genIfxJump
                            989 ;	Peephole 108.a	removed ljmp by inverse jump logic
   0E83 50 2E               990 	jnc	00118$
   ...
   0E85 EA                  996 	mov	a,r2
   0E86 25 41               997 	add	a,_Fault_Msg_Query_PARM_2
   0E88 FB                  998 	mov	r3,a
                            999 ;	Peephole 181	changed mov to clr
   0E89 E4                 1000 	clr	a
   0E8A 35 42              1001 	addc	a,(_Fault_Msg_Query_PARM_2 + 1)
   0E8C FC                 1002 	mov	r4,a
                           1003 ;	genAssign
   0E8D 90 00 BD           1004 	mov	dptr,#_fault_query_ndx
   0E90 E0                 1005 	movx	a,@dptr
                           1006 ;	genMult
                           1007 ;	genMultOneByte
   0E91 FD                 1008 	mov	r5,a
                           1009 ;	Peephole 105	removed redundant mov
   0E92 75 F0 11           1010 	mov	b,#0x11
   0E95 A4                 1011 	mul	ab
                           1012 ;	genPlus
   0E96 25 43              1013 	add	a,_Fault_Msg_Query_PARM_3
   0E98 FD                 1014 	mov	r5,a
                           1015 ;	Peephole 240	use clr instead of addc a,#0
   0E99 E4                 1016 	clr	a
   0E9A 35 44              1017 	addc	a,(_Fault_Msg_Query_PARM_3 + 1)
   0E9C FE                 1018 	mov	r6,a
                           1019 ;	genPlus
                           1020 ;	Peephole 236.g	used r2 instead of ar2
   0E9D EA                 1021 	mov	a,r2
                           1022 ;	Peephole 236.a	used r5 instead of ar5
   0E9E 2D                 1023 	add	a,r5
   0E9F F5 82              1024 	mov	dpl,a
                           1025 ;	Peephole 181	changed mov to clr
   0EA1 E4                 1026 	clr	a
                           1027 ;	Peephole 236.b	used r6 instead of ar6
   0EA2 3E                 1028 	addc	a,r6
   0EA3 F5 83              1029 	mov	dph,a
                           1030 ;	genPointerGet
                           1031 ;	genCodePointerGet
   0EA5 E4                 1032 	clr	a
   0EA6 93                 1033 	movc	a,@a+dptr
                           1034 ;	genPointerSet
                           1035 ;     genFarPointerSet
   0EA7 FD                 1036 	mov	r5,a
   0EA8 8B 82              1037 	mov	dpl,r3
   0EAA 8C 83              1038 	mov	dph,r4
                           1039 ;	Peephole 136	removed redundant move
   0EAC F0                 1040 	movx	@dptr,a
                    00B6   1041 	C$Extdebug.c$128$2$5 ==.
                           1042 ;	C:/SDCC/GPSMon/dev/Extdebug.c:128: if( buf[i] == NULL_CHAR )
                           1043 ;	genIfx
   0EAD ED                 1044 	mov	a,r5
                           1045 ;	genIfxJump
                           1046 ;	Peephole 108.c	removed ljmp by inverse jump logic
   0EAE 60 03              1047 	jz	00118$
   ...
   0EB1 80 CD              1055 	sjmp	00115$
   0EB3                    1056 00118$:
                    00BC   1057 	C$Extdebug.c$131$1$1 ==.
                           1058 ;	C:/SDCC/GPSMon/dev/Extdebug.c:131: fault_query_ndx++;
                           1059 ;	genAssign
   0EB3 90 00 BD           1060 	mov	dptr,#_fault_query_ndx
   0EB6 E0                 1061 	movx	a,@dptr
   0EB7 FA                 1062 	mov	r2,a
                           1063 ;	genPlus
   0EB8 90 00 BD           1064 	mov	dptr,#_fault_query_ndx
                           1065 ;     genPlusIncr
   0EBB 74 01              1066 	mov	a,#0x01
                           1067 ;	Peephole 236.a	used r2 instead of ar2
   0EBD 2A                 1068 	add	a,r2
   0EBE F0                 1069 	movx	@dptr,a
                    00C8   1070 	C$Extdebug.c$133$1$1 ==.
                           1071 ;	C:/SDCC/GPSMon/dev/Extdebug.c:133: return( TRUE );
                           1072 ;	genRet
   0EBF 74 01              1073 	mov	a,#0x01
   0EC1 24 FF              1074 	add	a,#0xff
   ...
   1565                    1082 _ALARM_MSG:
   1565 52 4F 4D 20 43 68  1083 	.ascii "ROM Checksum Err"
        65 63 6B 73 75 6D
        20 45 72 72
   1575 00                 1084 	.db 0x00
   1576 52 41 4D 20 43 68  1085 	.ascii "RAM Check Failed"
        65 63 6B 20 46 61
        69 6C 65 64
   1586 00                 1086 	.db 0x00
   1587 50 6F 77 65 72 53  1087 	.ascii "PowerSupply Fail"
        75 70 70 6C 79 20
        46 61 69 6C
   1597 00                 1088 	.db 0x00
   1598 46 50 47 41 20 43  1089 	.ascii "FPGA Check Fail "
        68 65 63 6B 20 46
        61 69 6C 20
   15A8 00                 1090 	.db 0x00
   15A9 56 43 4F 20 61 74  1091 	.ascii "VCO at rail"
        20 72 61 69 6C
   15B4 00                 1092 	.db 0x00
   15B5 00                 1093 	.db 0x00
   15B6 00                 1094 	.db 0x00
   15B7 00                 1095 	.db 0x00
   15B8 00                 1096 	.db 0x00
   15B9 0C                 1097 	.db 0x0C
   15BA 56 43 4F 20 4E 65  1098 	.ascii "VCO Near Rail"
