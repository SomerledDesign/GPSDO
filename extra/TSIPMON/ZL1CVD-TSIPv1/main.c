...
//
// Provides information about Tbolts health. 
// It is assumed, that Tbolt has been set up properly with TboltMonitor and/or LadyHeather(LH).
// No position or self survey data are shown. You should know where you are and
...
// ZL1CVD Notes - 4th July 2015
// ----------------------------
// - Original project & code from Götz Romahn http://www.g-romahn.de/tbolt2lcd/index.htm
// - Götz based his code on TSIP2LCD http://lea.hamradio.si/~s56wix/gps/ and is aware of my experiments
// - I wanted to use this to display status of a Nortel NTGS50AA GPSTM with Trimble firmware
// - NTGS50AA by default does not output serial data, you need to initially wake it up
// - Lady Heather (http://www.ke5fx.com/heather/readme.htm) Windows software does this by sending specific control strings
// - Updated Götz's hardware to include serial TX - original has just serial RX. Designed & produced PCB's - TSIPv1
// - Added usart_putchar & usart_pstr fuctions to support serial TX hardware
// - Added code to output Lady Heather's wakeup_nortel function
// - Did not confirm added serial TX functionality actually worked with NTGS50AA due to NTGS50AA hardware failure
// - Confirmed serial RX works with Nortel GPSTM (Trimble firmware v 3.62)
// ZL1CVD Notes - END
// ----------------------------
...
const char disciplinmode0[]   PROGMEM = "DIS - Normal    ";
const char disciplinmode1[]   PROGMEM = "DIS - Power up  ";
const char disciplinmode2[]   PROGMEM = "DIS - A Holdover";
const char disciplinmode3[]   PROGMEM = "DIS - M Holdover";
const char disciplinmode4[]   PROGMEM = "DIS - Recovery  ";
const char disciplinmode5[]   PROGMEM = "DIS - N/A       ";
const char disciplinmode6[]   PROGMEM = "DIS - Disabled  ";
const char disciplinmodeu[]   PROGMEM = "DIS - Unknown   ";	// should never happen

//decoding Status Byte 12
const char decodingstatus0[]  PROGMEM = "GPS - Doing fix ";
const char decodingstatus1[]  PROGMEM = "GPS - No time.. ";
const char decodingstatus2[]  PROGMEM = "GPS - ??Status??";
const char decodingstatus3[]  PROGMEM = "GPS - PDOP 2high";
const char decodingstatus8[]  PROGMEM = "GPS - No sats!  ";
const char decodingstatus9[]  PROGMEM = "GPS - only 1 sat";
const char decodingstatus10[] PROGMEM = "GPS - only 2 sat";
const char decodingstatus11[] PROGMEM = "GPS - only 3 sat";
const char decodingstatus12[] PROGMEM = "GPS - Sat error ";
const char decodingstatus16[] PROGMEM = "GPS - TRAIM rjct";
const char decodingstatusu[]  PROGMEM = "GPS - Unknown   ";	// should never happen

//decoding Disciplining Activity Byte 13 
const char decodingactivity0[]  PROGMEM = "Phase locking   ";
const char decodingactivity1[]  PROGMEM = "OCXO warm up";
...
const char decodingmalarm0[]   PROGMEM = "! DAC near max !";
const char decodingmalarm1[]   PROGMEM = "! Ant - open   !";
const char decodingmalarm2[]   PROGMEM = "! Ant - short  !";
const char decodingmalarm3[]   PROGMEM = "! No sats      !";
const char decodingmalarm4[]   PROGMEM = "! Not disc Osc !";
const char decodingmalarm5[]   PROGMEM = "! Surveying... !";
const char decodingmalarm6[]   PROGMEM = "! No Position  !";
const char decodingmalarm7[]   PROGMEM = "! Leap sec pend!";
const char decodingmalarm8[]   PROGMEM = "! In test mode !";
const char decodingmalarm9[]   PROGMEM = "! Position  ?? !";
const char decodingmalarm10[]  PROGMEM = "! EEPROM error !";
const char decodingmalarm11[]  PROGMEM = "! Almanach err !";
const char decodingmalarm12[]  PROGMEM = "! No PPS       !";	// message not generated by tbolt
const char decodingmalarmu[]   PROGMEM = "! Unknown Alarm!";	// should never happen
...
int main(void)
{
	...
	lcd_clrscr();
	//lcd_puts_p(PSTR("  GPSTM ZL1CVD"));		// greeting
	lcd_puts_p(PSTR(" TSIP v1 ZL1CVD"));		// greeting
	lcd_gotoxy(0, 1);
	lcd_puts_p(PSTR("< GPSDO STATUS >"));
	_delay_ms(2000);
...
// no packet received
		if ((time() > (lastgpspkt + 2)) && newsec) {		// do it only once per second
			lcd_clrscr();
			lcd_puts_p(PSTR("GPSDO Connected?"));
			lcd_gotoxy(0, 1);
			lcd_puts_p(PSTR("No comms.."));
			itoa(time() - lastgpspkt, lcdScreen, 10);
			lcd_gotoxy(12, 1);
			lcd_puts(lcdScreen);

// ZL1CVD - Following taken from Ladey Heather wakeup_nortel			
			usart_putchar(0x27);
			usart_putchar(0x10); usart_putchar(0x13); //LF, CR
			usart_putchar(0x26);
			usart_putchar(0x10); usart_putchar(0x13); //LF, CR
			usart_putchar(0x24);
			usart_putchar(0x10); usart_putchar(0x13); //LF, CR
