M:iconv
F:G$AsciiToUnsigned$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$UnsignedToAscii$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$CharToAscii$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LAsciiToUnsigned$p_int$1$1({3}DG,SI:U),E,0,0
S:LAsciiToUnsigned$p_ascii$1$1({2}DX,SC:U),R,0,0,[r2,r3]
S:LAsciiToUnsigned$i$1$1({1}SC:U),R,0,0,[r7]
S:LAsciiToUnsigned$n$1$1({1}SC:U),R,0,0,[r4]
S:LAsciiToUnsigned$value$1$1({2}SI:U),R,0,0,[r5,r6]
S:LUnsignedToAscii$pbuf$1$1({2}DX,SC:U),E,0,0
S:LUnsignedToAscii$nbdigits$1$1({1}SC:U),E,0,0
S:LUnsignedToAscii$value$1$1({2}SI:U),R,0,0,[r2,r3]
S:LUnsignedToAscii$ndx$1$1({1}SC:S),R,0,0,[r5]
S:LUnsignedToAscii$remainder$1$1({2}SI:U),R,0,0,[r1,r4]
S:LUnsignedToAscii$result$1$1({2}SI:U),R,0,0,[r7,r0]
