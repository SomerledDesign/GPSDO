...
* v0.4.0 21Aug16	K. Murphy  Added support for 2x20 VFD
							   Ported code to Atmega2560
...
#define GPS_OFFSET 	17	// 17 seconds until the next leap second in December

/*-----------------------------------------------------------------------------
* version:							  01234567890123456789	
*-----------------------------------------------------------------------------*/
static const char VersionMsg[]     = "   TSIPMon v0.4.0   ";  // make 20 char long
static const char VFDInitMsg[] 	   = "        W8VOS       ";  // make 20 char long
