M:Extdebug
F:G$Fault_Msg_Query$0$0({2}DF,SB0$1:U),Z,0,0,0,0,0
S:FExtdebug$fault_query_ndx$0$0({1}SC:U),F,0,0
...
S:G$ALARM_MSG$0$0({272}DA16,DA17,SC:U),D,0,0
S:FExtdebug$__xinit_fault_query_ndx$0$0({1}SC:U),C,0,0
